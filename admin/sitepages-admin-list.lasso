...
// for category search
Inline(-findall,$dbConfig, -table=$table_prefix + 'sitecats_admin',-sortfield='sortcode');
     var('cats1' = string);
     var('cats2' = string);
     records;
	$cats1 += ';' + (field('id'));
...
var('editlink_temp' = "<a href=\"sitepages-admin-form.html?haku=1&id=[$fieldvalue]\" TITLE=\"Edit this item\">[$fieldvalue]</a>
");
...
// array('menuname_lang2','Nimi (en)','text','','120px','','','',''),
array('address','Osoite','text','req,unique','120px','','oltava uniikki, esim. <b>edutjahaitat','',''),
