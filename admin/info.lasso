...
<a name="upload">
<h4>Mitä tiedostoja voi ladata?</h4>
<p>
Tällä hetkellä sallitut tiedostotyypit: <b>[$allowed_file_suffixes]</b>. Tiedoston sallittu enimmäiskoko on <b>[$upload_maxk]</b> kilotavua.
</p>
<a name="upload">
<h4>Tallenna nimellä...</h4>
<p>
Voit joko käyttää oletusarvoa tai kirjoittaa tiedostolle uuden nimen. 
</p>
<a name="scaleParams">
<h4>Tallenna määräkokoisena (suositellaan)
</h4>
<p>
Jos ladattava tiedosto on kuva (jpg, gif) ja yksi tai useampi määräkoko 
on valittu, kuvasta tehdään lataamisen yhteydessä valitunlaiset kopiot. Alkuperäistä kuvatiedostoa ei tällöin tallenneta palvelimelle lainkaan.  
</p>
<p>
Sivuston julkisella puolella on oma esityslogiikka jokaiselle määräkoolle. Pienemmästä kuvasta johtaa aina linkki suurempaan kuvaesitykseen.  
</p>
<p>
Jos ladattava kuva on pienempi kuin jokin valituista määräkooista, kuvaa ei muokata, vaan alkuperäistä kuvaa käytetään kyseiseen näyttötarkoitukseen. 
</p>
[else]
<h1>Info</h1>
