...
array('heading','Pääotsikko (fi)','text','','','','','','',''),
array('heading_lang2','Pääotsikko (en)','text','','','','','','',''),
array('heading_lang3','Pääotsikko (se)','text','','','','','','',''),
array('content','Sivun sisältö','textarea_ckeditor','allowhtml','','','','','',''),
array('content_lang2','Sivun sisältö (en)','textarea_ckeditor','allowhtml','','','','','',''),
array('content_lang3','Sivun sisältö (se)','textarea_ckeditor','allowhtml','','','','','',''),
...
array('form','Sivulla on lomake','checkbox','','','','Lomakkeen sisältö ohjelmoidaan funktiossa MO_formelements, ks. <code>/inc/library.inc</code>','','',''),
));
